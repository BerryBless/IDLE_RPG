...
description: "커밋 메시지를 받아 git commit/push를 안전하게 수행하는 최종 실행자. 원격 유무·hook·claude 브랜치 자동 전환·충돌을 처리하며 파괴적 명령은 절대 쓰지 않는다."
---
...
원격 저장소 유무, pre-commit hook, claude 브랜치 자동 전환, 충돌을 모두 처리하며
